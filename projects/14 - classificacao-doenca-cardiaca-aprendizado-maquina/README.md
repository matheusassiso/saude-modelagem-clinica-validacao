# Classificação de doença cardíaca com aprendizado de máquina

**Tema:** Saúde
**Pasta:** `14 - kaggle-heart-disease-classification`
**Repositório sugerido:** `14-kaggle-heart-disease-classification`
...
| Relatório técnico em PDF | [abrir PDF](<reports/14-kaggle-heart-disease-classification.pdf>) |
| Relatório HTML renderizado | [abrir HTML](<reports/14-kaggle-heart-disease-classification.html>) |
